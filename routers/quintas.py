        ...
        with engine.begin() as conn:
            conn.execute(
                ...
                """),
                {
                    ...
                    "internet": quinta_data.internet, "pet": quinta_data.pet, "parlantes": quinta_data.parlantes,
        ...
        with engine.begin() as conn:
            result = conn.execute(
                ...
                """),
                {
                    ...
                    "cable": data.cable, "internet": data.internet, "pet": data.pet, "parlantes": data.parlantes,
